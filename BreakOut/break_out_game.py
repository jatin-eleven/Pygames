...
# This is the BreakOut game created in python using Pygame module
...
class wall():
    ...
    def create_wall(self):
        ...
        for row in range(rows):  # 6
            ...
            for col in range(columns):  # 6
                # generate x and y position for each blocks and rectangle for that...
                block_x = col * self.width
                block_y = row * self.height

                # expln : here generates a tile from (0, 0) to (100, 50)
...
class game_ball():
    ...
    def move(self):
            ...
            for item in row:
                ...
                if self.rect.colliderect(item[0]):
                    ...
                    if wall.blocks[row_count][item_count][2] == rand_block1 or wall.blocks[row_count][item_count][2] == rand_block2:
                        ...
                        # for deleting the entire column...
                ...
                # check if blocks still exists, in which the wall is not destroyed
        ...
        if self.rect.left < 0 or self.rect.right > screen_width:
            # after collision ball moves in opposite direction...
            self.speed_x *= -1
            mixer.music.load("E:/Python Pygame/BreakOut/resources/move.mp3")
            mixer.music.play()
        ...
        if self.rect.bottom > screen_height:
            self.game_over = -1
            mixer.music.load(
                "E:/Python Pygame/BreakOut/resources/gameover.mp3")
            mixer.music.play()
        ...
        if self.rect.colliderect(player_paddle):
            ...
            if abs(self.rect.bottom - player_paddle.rect.top) < collision_thresh and self.speed_y > 0:
                ...
                mixer.music.load(
                    "E:/Python Pygame/BreakOut/resources/move.mp3")
                mixer.music.play()
...
while run:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text("CLICK ENTER TO START", font,
                      text_col, 135, screen_height//2 + 100)
